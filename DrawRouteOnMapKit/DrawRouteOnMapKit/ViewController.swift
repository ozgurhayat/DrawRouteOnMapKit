...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let sourceLocation = CLLocationCoordinate2D(latitude:38.4237 , longitude: 27.1428)
        let destinationLocation = CLLocationCoordinate2D(latitude:41.0082 , longitude: 28.9784)
    ...
    func createPath(sourceLocation : CLLocationCoordinate2D, destinationLocation : CLLocationCoordinate2D) {
        ...
        sourceAnotation.title = "Izmir"
        if let location = sourcePlaceMark.location {
            sourceAnotation.coordinate = location.coordinate
        }
        
        let destinationAnotation = MKPointAnnotation()
        destinationAnotation.title = "Istanbul"
